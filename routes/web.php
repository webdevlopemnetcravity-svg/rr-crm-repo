...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    // Immigration CRUD (no "show")
    Route::resource('immigrations', ImmigrationController::class)->except(['show']);

    // Optional quick ping/debug route (remove later)
    Route::get('immigrations/ping', fn () => 'ok')->name('immigrations.ping');
...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::get('new-leads/get-counts', [LeadContactController::class, 'getLeadCounts'])->name('new-leads.get_counts');
    ...
    Route::get('appointments/{id}', [LeadContactController::class, 'showAppointment'])->name('appointments.show');
    Route::post('appointments/{id}/update', [LeadContactController::class, 'updateAppointment'])->name('appointments.update');
    Route::post('appointments/{id}/cancel', [LeadContactController::class, 'cancelAppointment'])->name('appointments.cancel');
    ...
    Route::get('lead-list/export', [LeadContactController::class, 'exportLeadList'])->name('lead-list.export');
    ...
    Route::get('check-qr-login', [AttendanceController::class, 'qrClockInOut'])->name('settings.qr-login');
