    ...
    <div class="row">
        <div class="col-lg-12 mb-4">
            <x-forms.checkbox :fieldLabel="__('app.status')" fieldName="google_status" fieldId="googleButton"
                fieldValue="enable" fieldRequired="true" :checked="$credentials->google_status == 'enable'" disabled="true" />
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <x-forms.text :fieldLabel="__('app.socialAuthSettings.googleClientId')"
                        ...
                        :fieldValue="$credentials->google_client_id" disabled="disabled"></x-forms.text>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <x-forms.input-group>
                            <input type="password" name="google_secret_id" id="google_secret_id"
                                ...
                                value="{{ $credentials->google_secret_id }}" disabled>
                    ...
                    <div class="alert alert-warning">
                        <div class="form-group mb-0">
                            <a href="{{ route('googleAuth') }}" class="btn btn-primary">
                                <i class="fa fa-google mr-2"></i>Get Google Token
                            </a>
        ...
        <div class="w-100 border-top-grey">
            <x-setting-form-actions>
                <x-forms.button-primary id="save_google_data" class="mr-3" icon="check" disabled>@lang('app.save')
...
<script>
    $(document).ready(function() {
        // Disable the google_client_id field
        $('#google_client_id').prop('disabled', true);
        
        // Disable checkbox toggle functionality
        $('#googleButton').prop('disabled', true);
        
        // Disable save button
        $('#save_google_data').prop('disabled', true);
    });
