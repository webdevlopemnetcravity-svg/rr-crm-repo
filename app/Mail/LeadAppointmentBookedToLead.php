...
class LeadAppointmentBookedToLead extends Mailable
{
    ...
    public function build()
    {
        ...
        $content .= '<strong>Scheduled By:</strong> ' . ($appointment->creator->name ?? 'Admin') . '<br>';
        ...
        return $this->from(config('mail.from.address'), $company->company_name ?? config('mail.from.name'))
            ->subject('Your Appointment Is Confirmed | RR Patel Overseas & Education')
